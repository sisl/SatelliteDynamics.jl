...
let
    ...
    tle = TLE(line1, line2)
    array_isapprox(sgp4(tle, tle.epoch), [7022.46647249, -1400.06656182, 0.05106558, 1.893831081, 6.405894873, 4.534806701], atol=1e-8)
    ...
    tle = TLE(line1, line2)
    # array_isapprox(sgp4(tle, tle.epoch), [2334.12240168, -41920.42940755, -0.03695311, 2.826320327, -0.065091320, 0.570935915], atol=1e-8)
    ...
    tle = TLE(line1, line2)
    # array_isapprox(sgp4(tle, tle.epoch), [3988.29488121, 5498.97562026, 0.92898335, -3.290042995, 2.357636871, 6.496621836], atol=1e-8)
